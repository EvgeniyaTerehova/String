public class Main {
 ...
 В качестве данных для задачи используйте "Ivanov Ivan Ivanovich".*/
    ...
    public static void task1() {
        ...
        String midlName = "Ivanovich";
        String lastName = "Ivanov";
        String fullName = lastName + " " + firstName + " " + midlName;
  ...
  * заглавными буквами (верхним регистром).
  ...
  /** Система, в которой мы работаем, не принимает символ «ё». Напишите программу, которая заменяет символ «ё» на
   * символ «е».
